...
const MONGODB_URI   = "mongodb://localhost:27017/tweeter"; //tweeter is name of db
...
//the one time in the year when it's socially acceptable to eat pig intestines and read poetry